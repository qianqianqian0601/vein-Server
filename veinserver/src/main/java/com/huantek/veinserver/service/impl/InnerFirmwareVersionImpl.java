...
import com.huantek.veinserver.dao.InnerFirmwareVersionDao;
...
@Service
public class InnerFirmwareVersionImpl implements InnerFirmwareVersionService {
    @Autowired
    private InnerFirmwareVersionDao firmDao;
